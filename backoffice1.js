class Phone {
  ...
  const getPhoneData = function () {
    ...
    fetch(`https://striveschool-api.herokuapp.com/api/product/${phoneId}`, {
      ...
      .then((phone) => {
        ...
        document.getElementById('description').value = hone.description
  ...
  const submitEvent = function (e) {
    ...
    fetch(URL, {
      ...
      headers: {
        Authorization: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NzM3MGUyYThhZDEyOTAwMTU4NzZiYzkiLCJpYXQiOjE3MzE2NjEzNTUsImV4cCI6MTczMjg3MDk1NX0.aPbkDQM6a5DKRMxXYI4tnNpyUhuP9FrUorVLyC9W5Wk",
